...
<%
    ...
    String good_id,good_name,good_price,good_num;
...
<div class="mainbody01">
    <form action="/Update" method="get">
        <table class="mainbody02">
            <caption>货架&nbsp<%=good_id%></caption>
            <td><input type="hidden" name="id" value="<%=good_id%>"></td>
            <tr>
                <td>商品名字：</td>
                <td><input type="text" name="name" value="<%=good_name%>"></td>
            </tr>
            <tr>
                <td>商品单价：</td>
                <td><input type="text" name="price" value="<%=good_price%>"></td>
            </tr>
            <tr>
                <td>商品数量：</td>
                <td><input type="text" name="num" value="<%=good_num%>"></td>
            </tr>
        </table>
        <hr>
        <input type="submit" value="确定修改"class="backtrack">
